...
const AuthBackground = () => {
  ...
  return (
    <Box sx={{ position: 'absolute', filter: 'blur(200px)', zIndex: -1, bottom: 0 }}>
      <svg width="100%" height="calc(100vh - 0px)" viewBox="0 0 405 809" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
