    ...
    <div className="container">
      <Grid item xs={12}>
        ...
        <Typography variant="h6" color="textSecondary" gutterBottom>
          <FormattedMessage id="academy" /> / <FormattedMessage id="finance" />
        </Typography>
      </Grid>
      <ValidateSubscription name="Finance" objUser={user.academy} objAdmin={academy.academy} />
      <div className="row">
        {publications.finance.map((item) => (
