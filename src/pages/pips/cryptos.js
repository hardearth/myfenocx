    ...
    <div className="container">
      <Grid item xs={12}>
        <Typography variant="h1" gutterBottom>
          <FormattedMessage id="cryptos" />
        </Typography>
        <Typography variant="h6" color="textSecondary" gutterBottom>
          <FormattedMessage id="pips" /> / <FormattedMessage id="cryptos" />
        </Typography>
      </Grid>
      <ValidateSubscription name="Cryptos" objUser={user.pips} objAdmin={pips.pips} />
