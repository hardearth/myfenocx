    ...
    <div className="container">
      <Grid item xs={12}>
        <Typography variant="h1" gutterBottom>
          <FormattedMessage id="forex" />
        </Typography>
        <Typography variant="h6" color="textSecondary" gutterBottom>
          <FormattedMessage id="pips" /> / <FormattedMessage id="forex" />
        </Typography>
      </Grid>
      <ValidateSubscription name="Forex" objUser={user.pips} objAdmin={pips.pips} />
